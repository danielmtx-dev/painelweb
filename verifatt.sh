...
wget -P /home https://github.com/danielmtx-dev/painelweb/raw/main/install/verpweb > /dev/null 2>&1
[[ -f "/home/verpweb" ]] && {
...
wget -P /home https://github.com/danielmtx-dev/painelweb/raw/main/install/verweb > /dev/null 2>&1
[[ -f "/home/verweb" ]] && {
